...
DROP MATERIALIZED VIEW IF EXISTS sc.materialized_closings_by_day_and_berater;

-- create view
CREATE MATERIALIZED VIEW sc.materialized_closings_by_day_and_berater AS 
with closings AS (
...
-- make unique index
Create UNIQUE INDEX ON sc.materialized_closings_by_day_and_berater (datum, berater);

-- set owner
ALTER MATERIALIZED VIEW sc.materialized_closings_by_day_and_berater OWNER to read_only;
