--drop view 
DROP MATERIALIZED VIEW IF EXISTS sc.materialized_salesstage;

-- Create view
CREATE MATERIALIZED VIEW sc.materialized_salesstage AS
...
-- set owner
ALTER MATERIALIZED VIEW sc.materialized_salesstage OWNER to read_only;