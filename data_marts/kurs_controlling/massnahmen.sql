 ...
 SELECT massnahmen_organisation_courses.app_item_id,
	...
	concat('CRSE', massnahmen_organisation_courses.courses_sales_management::json ->> 'app_item_id'::text) AS massnahmen_id_sales,
...
-- Set table owner
ALTER TABLE kc.masssnahmen OWNER TO read_only;